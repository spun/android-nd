...
import com.spundev.popularmovies.databinding.FragmentMainActivityRatedBinding;
import com.spundev.popularmovies.loader.MoviesLoader;
import com.spundev.popularmovies.model.TMDBMovie;

import java.util.List;

public class MainActivityRatedFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<TMDBMovie>> {

    // Loader id
    private static final int RATED_LOADER = 20;
    ...
    public interface Callback {
        void onRatedItemSelected(TMDBMovie movie);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Data binding
        FragmentMainActivityRatedBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_main_activity_rated, container, false);
        ...
        moviesRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), numColumns));
        ...
        mMoviesAdapter = new MoviePostersAdapter(new MoviePostersAdapter.MoviePostersAdapterOnClickHandler() {
            ...
            public void onClick(TMDBMovie movie) {
                ...
                ((Callback) getActivity()).onRatedItemSelected(movie);
            }
        });
    ...
    public Loader<List<TMDBMovie>> onCreateLoader(int id, Bundle args) {
        if (id == RATED_LOADER) {
            ...
            return new MoviesLoader(getActivity(), MoviesLoader.SORT_ORDER_RATED);
        }
        return null;
    }
    ...
    public void onLoadFinished(Loader<List<TMDBMovie>> loader, List<TMDBMovie> data) {
        ...
        if (loaderId == RATED_LOADER) {

            // Send received movies to the adapter
